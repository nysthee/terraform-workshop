// This module creates an AWS keypair named "terraform-tutorial" using a pre-
// packaged SSH public key in this tutorial. We will discuss modules in more
...
// attributes.
module "ssh_keys" {
  // This defines where the module likes. Modules can reside in source control
